...
let label1 = form.querySelector('#label1');
let label2 = form.querySelector('#label2');
let label3 = form.querySelector('#label3');
let errorMsg = form.querySelector('#error-msg');
let modalResult = document.querySelector('.modal_result');
let good = modalResult.querySelector('#good');
let bad = modalResult.querySelector('#bad');
